    ...
    <div id="viewData" tabindex="-1" class="bg-opacity-50 fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6">
                    <h3 class="mb-5 text-center text-xl font-normal text-gray-700 dark:text-gray-400">Product Details</h3>
                    <div>
                        ...
                        <strong>Amount : </strong><span id="view_amount"></span><br>
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_category').innerHTML = data[1];
            document.getElementById('view_name').innerHTML = data[2];
            document.getElementById('view_amount').innerHTML = data[3];
            document.getElementById('view_note').innerHTML = data[4];
            document.getElementById('view_addby').innerHTML = data[5];
            document.getElementById('view_editby').innerHTML = data[6];
        });
    });
</script>
@endpush